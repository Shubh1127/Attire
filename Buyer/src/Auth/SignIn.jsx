...
export default function AuthTabs() {
  const { registerWithEmail, loginWithEmail, registerWithGoogle } = useBuyerContext();
            ...
            <TabsList className={`grid w-full grid-cols-2 ${
              ...
              <TabsTrigger 
                ...
                className={`cursor-pointer ${
                  theme === 'dark' ? 'data-[state=active]:bg-navy-600 data-[state=active]:text-white' : ''
                }`}
              >
                Register
              </TabsTrigger>
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className={theme === 'dark' ? 'bg-navy-700 border-navy-600  text-white' : ''}
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 relative">
                    ...
                    <button
                      ...
                      className={`absolute right-3 top-8 ${
                        theme === 'dark' ? 'text-gray-400 hover:text-amber-400' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
            ...
            <TabsContent value="login">
              <CardContent className="space-y-4 py-6">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="login-email" className={theme === 'dark' ? 'text-gray-300' : ''}>
                      Email
                    </Label>
                    <Input
                      id="login-email"
                  ...
                  <div className="space-y-2 relative">
                    <Label htmlFor="login-password" className={theme === 'dark' ? 'text-gray-300' : ''}>
                      Password
                    </Label>
                    <Input
                      id="login-password"
